  ...
  return <>
    ...
    <Card className="mb-8 py-0">
      <CardContent className="grid p-0 sm:grid-cols-2 xl:grid-cols-[1.4fr_.65fr_.65fr_auto]">
        ...
        <div className="border-b p-5 sm:border-b-0 sm:border-r xl:border-r-0"><span className="text-xs text-muted-foreground">Connected workers</span><strong className="mt-2 block font-mono text-lg">{data.worker_count}</strong></div>
